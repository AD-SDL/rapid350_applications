...
class DionExperimentApplication(ExperimentApplication):
    ...
    def run_app(self):
        ...
        while time.time() - first_incubation_start_time < exposure_incubation_time:
            print(f"Incubating. Continuing in {int(exposure_incubation_time - (time.time() - first_incubation_start_time))} seconds. Please refill tips before incubation is complete!")
            time.sleep(5)

            if time.time() - first_incubation_start_time >= exposure_incubation_time:
